    ...
    <footer className="border-t border-border/30 bg-background/50 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-8">
          <div>
            <h4 className="text-lg font-semibold text-foreground mb-2">Digitomedia</h4>
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-4">
          <p className="text-xs sm:text-sm text-muted-foreground">© 2025 Digitomedia. All rights reserved.</p>
